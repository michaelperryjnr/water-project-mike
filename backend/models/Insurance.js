...
const insuranceSchema = new mongoose.Schema({
  ...
  provider: { type: String, required: true, trim: true }, // Frontend: Text input
  ...
  startDate: { type: Date, required: true }, // Frontend: Date picker
  endDate: { type: Date, required: true }, // Frontend: Date picker
}, { timestamps: true });
