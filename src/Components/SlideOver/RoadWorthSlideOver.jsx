// src/SlideOver/RoadWorthSlideOver.jsx
...
export default function RoadWorthSlideOver({ isOpen, onClose, data }) {
  console.log('RoadWorth Data:', data);
                  ...
                  <div className="px-4 py-6 sm:px-6">
                    <div className="flex items-start justify-between">
                      <Dialog.Title className="text-lg font-medium text-gray-900">
                        Roadworthiness Certificate: {data.certificateNumber}
                      </Dialog.Title>
                      ...
                      <div className="-mt-12 px-4 sm:-mt-8 sm:flex sm:items-end sm:px-6 lg:-mt-15">
                        <div className="mt-6 sm:flex-1">
                          ...
                          <p className="text-sm text-gray-500">
                            Issued By: {capitalizeWords(data.issuedBy)}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="px-4 py-5 sm:px-0 sm:py-0">
                      <dl className="space-y-8 sm:divide-y sm:divide-gray-200 sm:space-y-0">
                        ...
                        <div className="sm:flex sm:px-6 sm:py-5">
                          ...
                          <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:ml-6 sm:col-span-2">
                            {capitalizeWords(data.notes) || 'N/A'}
                          </dd>
                        </div>
                        <div className="sm:flex sm:px-6 sm:py-5">
                          <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0 lg:w-48">
                        ...
                        <div className="sm:flex sm:px-6 sm:py-5">
                          ...
                          <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:ml-6 sm:col-span-2">
                            {new Date(data.updatedAt).toLocaleDateString() || 'N/A'}
                          </dd>
                        </div>
                      </dl>
                    </div>
