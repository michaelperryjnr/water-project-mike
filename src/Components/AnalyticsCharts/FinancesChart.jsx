    ...
    <div className="rounded-2xl border border-gray-200 bg-white">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500 text-theme-sm">
              Amount deposited at the bank(s) today.
            </p>
          </div>
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          An amount of GHS 3,287 was deposited at BankName by DepositorsFirstAndLastName today. It is higher/lower than yesterday's deposit.
        </p>
      </div>
